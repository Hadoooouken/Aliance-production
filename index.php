...
<body class="main-page">
    ...
    <main>
        <section class="section section--light">
            <div class="container">
                ...
                <div class="nav-arrows slider__steps-wrapper">
                    <button
                        class="nav-arrows__button nav-arrows__button--sm nav-arrows__button--prev js-slider-steps-prev">
                    ...
                    <button
                        class="nav-arrows__button nav-arrows__button--sm nav-arrows__button--next js-slider-steps-next">
                        <svg class="arrow" width="30" height="20">
                            <use href="./images/sprites.svg#arrow-next"></use>
                        </svg>
                    </button>
        ...
        <section class="section production">
            <div class="container">
                <div class="separator"></div>
                <h2 class="section__title">Контрактное производство</h2>
                <ul class="card__list">
